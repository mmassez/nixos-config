...
#+BEGIN_SRC emacs-lisp
  (setq user-full-name "Mathias Massez"
    user-mail-address "mathias@massez.be")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/mmassez/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/mmassez/bin" "/profile/bin" "/Users/mmassez/.npm-packages/bin" "/Users/mmassez/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC
